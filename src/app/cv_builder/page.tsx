    ...
    <div className="flex flex-col h-screen bg-gray-100 dark:bg-gray-900">
          ...
          {loading ? (
            ...
            <>
              {output ? (
                ...
                <p className="text-gray-600">No CV generated yet.</p>
              )}
            </>
          )}
        </div>
      ...
      <div className="p-4 bg-gray-200 dark:bg-gray-800">
        <div className="flex">
          ...
          <button
            onClick={getCv}
            className="p-2 bg-blue-600 rounded-r-lg"
            disabled={loading}
          >
      ...
      <footer className="p-2 bg-gray-300 dark:bg-gray-800 text-center text-sm text-gray-700 dark:text-gray-400">
        <p className="font-semibold">Valentinov Software</p>
